...
public class PlaylistsActivity extends AppCompatActivity implements View.OnClickListener {

    private TextView toHome, toAlbums, toArtists, toSongs;
    ...
    public void onClick(View v) {
        ...
        switch (_id) {
            ...
            case R.id.goToAlbums:
                ...
                Intent intent_2 = new Intent(PlaylistsActivity.this, AlbumsActivity.class);
            ...
            case R.id.goToArtists:
                ...
                Intent intent_3 = new Intent(PlaylistsActivity.this, ArtistsActivity.class);
            ...
            case R.id.goToSongs:
                ...
                Intent intent_4 = new Intent(PlaylistsActivity.this, SongsActivity.class);
